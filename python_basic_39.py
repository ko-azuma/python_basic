...
# 関数 judge を定義してください
# judgeという名前の関数を定義して、引数を受け取れるようにしてください。ただし、第１引数に対応する仮引数名をplayer、第２引数に対応する仮引数名をcomputerとしてください。
def judge(player,computer) :
    ...
    # 上記３つの条件のとき、それぞれ文字列'勝ち'を戻り値として返してください。ただし、それぞれの条件は「or」 ではなく、１つずつ「elif」を用いてください。
...
if validate(player_hand):
    ...
    # 変数 result を出力してください('結果は○○でした'となるように出力してください。○○には変数resultを入れてください。)
